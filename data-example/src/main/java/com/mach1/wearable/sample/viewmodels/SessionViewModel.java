package com.mach1.wearable.sample.viewmodels;
...
import com.mach1.wearable.sample.Event;
...
public class SessionViewModel extends ViewModel implements WearableDeviceListener {
    ...
    public void toggleVoicePrompts(@NonNull final VoicePromptValue value) {
        final WearableDevice wearableDevice = device();
        if (wearableDevice != null) {
            wearableDevice.changeVoicePrompts(value.toggle());
        }
    }
